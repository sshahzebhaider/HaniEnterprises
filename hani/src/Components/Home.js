        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2">
          ...
          <div className="hidden lg:block">
            <ul className="inline-flex space-x-8">
              <li className="text-sm font-semibold text-gray-800 hover:text-gray-900"><Link to="/">Home</Link></li>
              <li className="text-sm font-semibold text-gray-800 hover:text-gray-900"><Link to="/testimonials">Testimonials</Link></li>
              <li className="text-sm font-semibold text-gray-800 hover:text-gray-900"><Link to="/about">About Us</Link></li>
            </ul>
          </div>
          <div className="hidden lg:block">
            <button
                ...
                <div className="px-5 pb-6 pt-5">
                  <div className="flex items-center justify-between">
                    <div className="inline-flex items-center space-x-2">
                      ...
                      <span className="font-bold">Hani Enterprises</span>
                    </div>
                    <div className="-mr-2">
                      <button
                        type="button"
        ...
        <div className="mx-auto max-w-7xl lg:px-8">
          <div className="flex flex-col justify-center px-4 py-10 lg:px-6">
            ...
            <p className="mt-8 max-w-3xl text-lg text-gray-700">
              Welcome to Hani Enterprises – Your Trusted Partner in Rice Trading!
            </p>
            <p className="mt-8 max-w-3xl text-lg text-gray-700">
              Discover a world of rice varieties at Hani Enterprises. From aromatic Basmati to versatile long-grain rice, we offer a wide range of premium quality rice products. Our commitment to quality is reflected in every pack we deliver, promising a delightful culinary experience.
            </p>
            {/* <div className="mt-8">
              <button
                type="button"
          ...
          <div className="rounded-lg bg-gray-200 p-4">
            <img
              ...
              src="https://bhandarifoods.com/wp-content/uploads/2021/09/Rice-platform-scaled-1.jpg"
              alt=""
            />
          </div>
        </div>
      ...
      <div className="mx-auto my-12 max-w-7xl px-4 sm:px-6 md:my-24 lg:my-32 lg:px-8">
        ...
        <div className="mt-12 grid grid-cols-1 gap-y-8 text-center sm:grid-cols-2 sm:gap-12 lg:grid-cols-4">
          <div>
            ...
            <h3 className="mt-8 text-lg font-semibold text-black">Pricing</h3>
            <p className="mt-4 text-sm text-gray-600">
              We offer competitive prices that reflect the true value of our premium rice products. Our commitment to integrity extends to our pricing.
            </p>
          </div>
          <div>
            <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-gray-100">
              <ShieldCheck className="h-9 w-9 text-gray-700" />
            </div>
            <h3 className="mt-8 text-lg font-semibold text-black">Quality</h3>
            <p className="mt-4 text-sm text-gray-600">
              Our commitment to excellence ensures that you receive rice of unparalleled quality, consistently meeting and exceeding industry benchmarks.
            </p>
          </div>
          <div>
            <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-gray-100">
              <PackageCheck className="h-9 w-9 text-gray-700" />
            </div>
            <h3 className="mt-8 text-lg font-semibold text-black">Packaging</h3>
            <p className="mt-4 text-sm text-gray-600">
              We offer innovative packaging solutions designed to protect against environmental factors and ensure the longevity of your rice products.
            </p>
          </div>
          <div>
            <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-gray-100">
              <Smile className="h-9 w-9 text-gray-700" />
            </div>
            <h3 className="mt-8 text-lg font-semibold text-black">Customer Satisfaction</h3>
            <p className="mt-4 text-sm text-gray-600">
              We value feedback and continuously strive to improve our services based on the evolving needs of our customers.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="mx-auto max-w-xl text-center">
          ...
          <section className="px-2 py-10 md:px-0">
            <figure className="mx-auto max-w-2xl">
              <h2 className="mt-6 text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">Client Satisfaction</h2>
              <blockquote className="mt-10 text-xl text-gray-900">
                <p>
                  "Working with Hani Enterprises has been an absolute pleasure. Their commitment to quality and reliability is unmatched in the industry. The consistent supply of premium rice varieties has allowed our business to thrive, and we appreciate the transparent communication and seamless transactions. Highly recommended!"
                </p>
              </blockquote>
              <figcaption className="mt-10 inline-flex items-center space-x-2">
                ...
                <div>
                  <p className="font-semibold text-black">100+ Clients</p>
                </div>
              </figcaption>
            </figure>
          </section>
          ...
          <div className="-m-8 flex flex-wrap items-center justify-between">
            <div className="w-auto p-8">
              <a href="#">
                ...
                <img src={logo} width='50' height='50' />
                  <span className="ml-4 text-lg font-bold">Hani Enterprises</span>
                </div>
              </a>
            </div>
            <div className="w-auto p-8">
