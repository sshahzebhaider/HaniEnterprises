        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2">
          ...
          <div className="hidden lg:block">
            <ul className="inline-flex space-x-8">
              ...
              <li className="text-sm font-semibold text-gray-800 hover:text-gray-900"><Link to="/about">About</Link></li>
            </ul>
          </div>
          <div className="hidden lg:block">
            <button
      ...
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="flex flex-col space-y-8 pb-10 pt-12 md:pt-24">
          ...
          <p className="max-w-4xl text-base text-gray-600 md:text-xl">
            Welcome to Hani Enterprises, your trusted partner in the world of rice trading. Established with a vision to provide premium quality rice to global markets, we take pride in our commitment to excellence, integrity, and customer satisfaction.
          </p>
          <p className="max-w-4xl text-base text-gray-600 md:text-xl">
            At Hani Enterprises, our mission is to be a leading player in the rice trading industry by consistently delivering superior quality rice products to our clients worldwide. We strive to build enduring relationships with both our suppliers and customers, fostering a culture of trust and reliability.
          </p>
        </div>
        ...
        <div className="mt-16 flex items-center">
          <div className="space-y-6 md:w-3/4">
            <p className="text-3xl font-bold text-gray-900 md:text-4xl">Meet our CEO</p>

            <div></div>
          </div>
        </div>
        {/* TEAM */}
        <p className="mt-8 max-w-3xl text-lg text-gray-700">Dear Valued Partners,</p>
        <p className="mt-8 max-w-3xl text-lg text-gray-700">
          I am delighted to extend my heartfelt gratitude for your continued support and trust in Hani Enterprises. As the CEO, it is my privilege to share a message that reflects the spirit and vision that drive our company forward.
        </p>
        <p className="mt-8 max-w-3xl text-lg text-gray-700">
          At Hani Enterprises, we are not just merchants; we are stewards of a tradition that spans generations, connecting farmers with markets and cultures with nourishment. Our commitment to excellence, integrity, and sustainability is at the core of everything we do.
        </p>
        <p className="mt-8 max-w-3xl text-lg text-gray-700">
          Thank you for being an essential part of our story. Together, let's shape a future where the exchange of rice represents not just commerce but a celebration of culture, sustenance, and enduring partnerships.
        </p>
        <p className="mt-8 max-w-3xl text-lg text-gray-700">
          Warm regards,
        </p>
