        ...
        <div className="w-full">
            ...
            <div className="mx-auto max-w-xl text-center">
                ...
                <section className="px-2 py-10 md:px-0">
                    ...
                    <h2 className="mt-6 text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">Our Satisfied Clients</h2>
                    <hr className="mt-6" />
                            ...
                            <div className="mt-10 md:mt-0">
                                <blockquote>
                                    <p className="text-xl text-black">
                                        “We have been impressed with Hani Enterprises' ability to adapt to market trends and provide innovative solutions. Their forward-thinking approach, combined with a deep understanding of the rice market, has been invaluable to our business. We wholeheartedly endorse them as a reliable and strategic trading partner.”
                                    </p>
                                </blockquote>
                                <p className="mt-7 text-lg font-semibold text-black">Jehanzeb Haider</p>
                                <p className="mt-1 text-base text-gray-600">Client</p>
                            </div>
                        </div>
                    </div>
                    <hr className="mt-6" />
                    <div className="mt-5 mx-auto max-w-4xl">
                        <div className="md:flex md:items-center md:justify-center md:space-x-14">
                            ...
                            <div className="mt-10 md:mt-0">
                                <blockquote>
                                    <p className="text-xl text-black">
                                        “Working with Hani Enterprises has been a game-changer for our retail business. The reliability of their supply chain, coupled with competitive pricing, has significantly boosted our profitability. Their customer-centric approach and commitment to quality make them a standout partner in the rice trading industry.”
                                    </p>
                                </blockquote>
                                <p className="mt-7 text-lg font-semibold text-black">Usama</p>
                                <p className="mt-1 text-base text-gray-600">Client</p>
                            </div>
                        </div>
                    </div>
