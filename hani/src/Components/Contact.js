...
import { Menu, X, MapPin, Phone, Mails } from 'lucide-react'
        ...
        <div>
            ...
            <div className="mx-auto max-w-7xl px-4">
                ...
                <div className="flex flex-col space-y-8 pb-10 pt-12 md:pt-24">
                    ...
                    <p className="mx-auto max-w-xl text-center text-3xl font-bold text-gray-900 md:text-5xl md:leading-10">
                        Reach Us At
                    </p>
                ...
                <div className="my-8 flex flex-col gap-y-6 md:flex-row lg:justify-around">
                    ...
                    <div key="Our Location" className="flex flex-col space-y-3 md:w-2/4 lg:w-1/5">
                    ...
                    <div key="Our Location" className="flex flex-col space-y-3 md:w-2/4 lg:w-1/5">
                        ...
                        <p className="w-full text-xl font-semibold  text-gray-900">Phone</p>
                        <p className="text-sm font-medium">
                            +92-335-2239090
                        </p>
                    </div>
